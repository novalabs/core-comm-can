...
bool calendar_check(hrt_calendar_t * calp, uint16_t slot, uint16_t period) {
...
bool calendar_set_slot(hrt_calendar_t * calp, hrt_msg_t * msgp) {
	hrt_msg_t * curr_msgp = (hrt_msg_t *)calp;
	int slot = 1;
...
bool hrt_reserved_slot(RTCANDriver * rtcanp) {
